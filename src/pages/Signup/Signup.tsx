...
const Signup = () => {
  ...
  return (
    <>
      <AuthForm title="Signup Form" fields={fields} onSubmit={handleSubmit(handleSignup)} register={register} errors={errors} buttonText="Signup" googlebtn={<GoogleSigninButtons />} />
    </>
  )
}
